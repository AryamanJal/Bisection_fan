...
This repo contains a Jupyter notebook and executable polymake scripts for visualising $2$ and $3$-dimensional bisection fans and computing bisection cones. The corresponding paper is "Polyhedral combinatorics of bisectors." The published version is available here: https://doi.org/10.1515/advgeom-2025-0003 and the arxiv version is available here: https://arxiv.org/abs/2308.14372. 
